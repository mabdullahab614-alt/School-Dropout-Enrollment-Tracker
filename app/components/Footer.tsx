...
export default function Footer() {
  return (
    <footer className="mt-20 relative overflow-hidden" style={{ background: "linear-gradient(135deg, #0f1410 0%, #16241a 50%, #0f1410 100%)", color: "#e8ece7" }}>
      <div className="absolute -top-24 -right-24 w-72 h-72 rounded-full opacity-10 pointer-events-none" style={{ background: "#60a5fa" }} />
      <div className="absolute -bottom-24 -left-24 w-72 h-72 rounded-full opacity-10 pointer-events-none" style={{ background: "#34d399" }} />

      <div className="max-w-5xl mx-auto px-6 py-16 relative">
        <div className="grid sm:grid-cols-4 gap-10 mb-12">
          <div className="sm:col-span-2">
            <div className="flex items-center gap-3 mb-3">
              <span className="w-11 h-11 rounded-xl flex items-center justify-center flex-shrink-0" style={{ background: "#60a5fa" }}>
              ...
              <div>
                <span className="font-display font-bold block leading-none tracking-tight" style={{ fontSize: "1.7rem" }}>Roll Call</span>
                <span className="block mt-1 italic tracking-wide" style={{ color: "#8fa08f", fontSize: "0.72rem" }}>Every child counted</span>
              </div>
            </div>
            <p className="text-sm leading-relaxed max-w-sm mb-5" style={{ color: "#a3ada3" }}>
              Helping parents, teachers, and community workers see the real out-of-school numbers for their district and find a nearby school to enroll a child.
            </p>
            <div className="flex flex-wrap items-center gap-3">
              <Link href="/#join-movement" className="btn inline-flex items-center gap-2 px-5 py-2.5 rounded-full text-sm font-medium" style={{ background: "#60a5fa", color: "#0f1410" }}>Join the Movement</Link>
              <a href="https://github.com/mabdullahab614-alt/School-Dropout-Enrollment-Tracker" target="_blank" rel="noopener noreferrer" className="btn inline-flex items-center gap-2 px-5 py-2.5 rounded-full text-sm font-medium" style={{ borderWidth: "1.5px", borderStyle: "solid", borderColor: "rgba(255,255,255,0.2)", color: "#e8ece7" }}>
          ...
          <div>
            <h3 className="text-sm font-bold uppercase tracking-wide mb-4" style={{ color: "#ffffff" }}>Quick links</h3>
      ...
      <div className="border-t relative" style={{ borderColor: "rgba(255,255,255,0.08)" }}>
        <div className="max-w-5xl mx-auto px-6 py-5 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs" style={{ color: "#a3ada3" }}>
