        ...
        <div className="grid sm:grid-cols-3 gap-10">
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              >
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#0f1410" strokeWidth="2">
                  <path d="M22 10v6M2 10l10-5 10 5-10 5-10-5z" />
                  <path d="M6 12v5c0 1.5 2.7 3 6 3s6-1.5 6-3v-5" />
                </svg>
              </span>
              <span className="font-display text-lg font-bold">Roll Call</span>
            </div>
            ...
            <a href="https://github.com/mabdullahab614-alt/School-Dropout-Enrollment-Tracker" target="_blank" rel="noopener noreferrer" className="btn inline-flex items-center gap-2 mt-4 text-sm hover:opacity-80 transition-opacity">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm" style={{ color: "#a3ada3" }}>
              ...
              <li><Link href="/lookup" className="hover:text-white transition-colors">Find a district</Link></li>
